...
for (address in addresses) {#address=    addresses = addresses[1:70]
...
write.csv(df,"C:\\Users\\Alex\\Desktop\\Crypto Jobs\\CFG ICO\\Output\\transfers_cfg.csv")
saveRDS(df,"C:\\Users\\Alex\\Desktop\\Crypto Jobs\\CFG ICO\\Output\\transfers_cfg.RData")
